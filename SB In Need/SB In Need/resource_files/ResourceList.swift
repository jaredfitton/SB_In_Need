...
class ResourceList {
    ...
    init() {
        ...
        createResource(name: "Santa Barbara Rescue Mission", type: .food, contact: "Phone: 805-966-1316", hours: "Daily breakfast at 5:45am\n Mon-Sat at 6:15pm and Sun at 5:15 pm", address: "535 E Yanonali St, SB, 93103", coordinate: CLLocationCoordinate2D(latitude: 34.419117, longitude: -119.684520), description: "Breakfast", image: UIImage(named: "resourceImages/Santa Barbara Rescue Mission.pg")!)
