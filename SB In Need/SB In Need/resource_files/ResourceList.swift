...
class ResourceList {
    ...
    init() {
        ...
        createResource(name: "Santa Barbara Rescue Mission", type: .food, contact: "Phone: 805-966-1316", hours: "Daily at 5:45 Army", address: "535 E Yanonali St, SB, 93103", coordinate: CLLocationCoordinate2D(latitude: 34.419117, longitude: -119.684520), description: "Breakfast", image: UIImage(named: "resourceImages/Santa Barbara Rescue Mission.png")!)
